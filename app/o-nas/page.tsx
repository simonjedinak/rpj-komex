...
export default function AboutPage() {
  return (
    <main className="flex-1 bg-white px-20 py-8 text-white">
      <section className="bg-metal inset-shadow-xl flex flex-col gap-y-8 p-8 relative">
        <div
        ...
        <div className="shadow-xl shadow-black/50 p-5 gap-20 pl-16 container flex flex-row from-[#2a2b2c] to-[#0c0d0f] bg-linear-to-b rounded-4xl border-black border-3 relative z-10">
        ...
        <div className="shadow-xl shadow-black/50 container overflow-hidden flex flex-row bg-linear-to-b from-[#2a2b2c] to-[#0c0d0f] rounded-4xl border-black border-3 relative z-10">
        ...
        <div className="shadow-xl shadow-black/50 p-5 gap-20 pl-16 container flex flex-row from-[#242425] to-[#0c0d0f] bg-linear-to-b rounded-4xl border-black border-3 relative z-10">
